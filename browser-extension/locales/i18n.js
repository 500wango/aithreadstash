...
const TRANSLATIONS = {
    ...
    zh: {
        ...
        footerCopyright: '© 2024 AI ThreadStash | <a href="https://axonflow.com" target="_blank">官方网站</a> | 版本 v1.0.0',
        ...
        supportedPlatformsDesc: '目前支持以下平台：',
        chatgptDesc: 'OpenAI官方平台',
        deepseekDesc: '深度求索AI助手',
        usageGuideTitle: '🚀 使用指南',
        userGuide: '使用指南',
        ...
        downloadMdDesc: '保存为.md文件',
        copyMarkdownDesc: '复制Markdown格式到剪贴板',
        copyRichTextDesc: '复制富文本格式到剪贴板',
        printDesc2: '生成PDF或直接打印',
        faqTitle: '常见问题',
        faq1Q: 'Q: 为什么导出按钮是灰色的？',
...
class I18n {
    ...
    detectLanguage() {
        ...
        // Force English for specific conditions
        // Check if UI culture is English (common in mixed environments)
        if (browserLang.startsWith('en') || browserLang === 'en-US') {
            return 'en';
        }
        
        // Check navigator.languages array for English preference
        ...
        // Check system UI language (Intl API) - important for mixed environments
        try {
            const intlLocale = Intl.DateTimeFormat().resolvedOptions().locale;
            if (intlLocale && intlLocale.startsWith('en')) {
                return 'en';
            }
        } catch (e) {
            // Intl detection failed, continue with other methods
        }
        
        // First try exact match
        if (SUPPORTED_LANGUAGES[browserLang]) {
            return SUPPORTED_LANGUAGES[browserLang];
        }
